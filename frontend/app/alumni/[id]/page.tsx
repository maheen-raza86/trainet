...
export default function AlumniDetailPage() {
  ...
  useEffect(()=>{
    fetch(`${API}/public/stats`).then(r=>r.json())
      .then(j=>{ const all=j.data?.alumni||[]; setProfile(all.find((a:any)=>a.id===id)||null); })
    ...
    <PublicLayout>
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden" style={{background:'#07071a'}}>
        ...
        <div className="container mx-auto max-w-3xl relative z-10">
          ...
          <div className="flex items-start gap-5">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-black text-white">{profile.profiles?.first_name} {profile.profiles?.last_name}</h1>
      ...
      <section className="py-16 px-6 relative" style={{background:'#07071a'}}>
        ...
        <div className="container mx-auto max-w-md text-center relative z-10 reveal">
          <p className="text-white/55 mb-5">Want to connect with {profile.profiles?.first_name}?</p>
          <Link href="/signup"
