        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
          ...
          <div>
            ...
            <select
              ...
              className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent ${
                errors.courseOfferingId ? 'border-red-500' : 'border-gray-300'
              }`}
            ...
            >
              ...
              {courses.map((offering) => (
                <option key={offering.id} value={offering.id}>
                  {offering.courses.title} ({offering.duration_weeks} weeks)
                </option>
              ))}
            </select>
            {errors.courseOfferingId && (
              <p className="mt-1 text-sm text-red-600">{errors.courseOfferingId.message}</p>
            )}
          </div>
